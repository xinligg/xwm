 ...
 * @author Xin Li
 *
 * @brief XWM configuration parser.
 *
 */
...
static const char *DEFAULT_TITLE = "XWM";
...
static const char * const CONFIG_FILES[] = {
  "$XDG_CONFIG_HOME/xwm/xwmrc",
  "$HOME/.config/xwm/xwmrc",
  SYSTEM_CONFIG
};
                                  ...
                                  const char *command)
{
   ...
   if(JUNLIKELY(!start || start->type != TOK_XWM))
   {
