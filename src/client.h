...
#define STAT_WMDIALOG   (1 << 7)    /**< This is a XWM dialog window. */
...
#define STAT_DRAG       (1 << 24)   /**< Pass mouse events to XWM. */
 ...
 * @param notOwner 1 if XWM doesn't own this window, 0 if XWM is the owner.
