...
typedef enum {
   ...
   ATOM_XWM_EXIT,
   ATOM_XWM_RELOAD,
   ATOM_XWM_WM_STATE_MAXIMIZED_TOP,
   ATOM_XWM_WM_STATE_MAXIMIZED_BOTTOM,
   ATOM_XWM_WM_STATE_MAXIMIZED_LEFT,
   ATOM_XWM_WM_STATE_MAXIMIZED_RIGHT,

   ATOM_COUNT
} AtomType;

extern const char xwmRestart[];
extern const char xwmExit[];
extern const char xwmReload[];
